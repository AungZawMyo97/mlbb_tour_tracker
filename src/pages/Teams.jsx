    ...
    <div className="space-y-12 animate-fadeIn">
      ...
      <div className="relative py-12 px-6 rounded-3xl overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-4">
          <h1 className="text-5xl md:text-6xl font-bold gradient-purple-blue bg-clip-text text-transparent drop-shadow-2xl tracking-tight">
            Pro Teams
          </h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto font-light leading-relaxed">
            Explore the elite organizations competing for glory in the Land of Dawn.
          </p>
        </div>
      </div>
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="mt-6 text-purple-300 animate-pulse font-medium">Summoning Teams...</p>
        </div>
      )}
      ...
      {error && !loading && (
        <div className="max-w-xl mx-auto bg-red-500/10 border border-red-500/50 rounded-2xl p-8 text-center backdrop-blur-sm">
          ...
          <p className="text-red-400 font-bold text-lg mb-2">Connection Severed</p>
      ...
      {!loading && !error && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {teams.map((team, index) => (
            ...
            >
              <div
                className="absolute inset-0 bg-gradient-to-br from-slate-800/80 to-slate-900/90 rounded-2xl border border-slate-700/50 group-hover:border-purple-500/50 transition-all duration-500 transform group-hover:-translate-y-2 group-hover:shadow-2xl group-hover:shadow-purple-500/20"
              ></div>
              ...
              <div className="relative p-6 flex flex-col items-center h-full z-10 transition-transform duration-500 group-hover:-translate-y-2">
                ...
                {/* Logo Container */}
                <div className="w-32 h-32 mb-6 relative group-hover:scale-110 transition-transform duration-500">
                  ...
                  {/* Fallback */}
                  <div className="hidden w-full h-full rounded-2xl bg-gradient-to-br from-slate-700 to-slate-800 items-center justify-center text-4xl font-bold relative z-10 border border-slate-600 shadow-inner">
                    <span className="gradient-purple-blue bg-clip-text text-transparent">
                      {team.name.charAt(0)}
                    </span>
                  </div>
                ...
                <div className="text-center w-full mt-auto">
                  <h3 className="text-xl font-bold text-white mb-1 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-blue-400 transition-all duration-300 truncate px-2">
                    {team.name}
                  </h3>
